...
def on_drop(event, values):
    ...
    from Seismicwidget import SeismicInputWidget, compute_seismic_load
    ...
    try:
        ...
        seismic_load = compute_seismic_load(self, site_class, importance_factor, spectral_response_acceleration)
